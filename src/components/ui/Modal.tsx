...
const Modal = ({ isOpen, onClose, children }: ModalProps) => {
  ...
  return (
    <div className="absolute top-0 left-0 w-full h-full z-50 flex items-center justify-center bg-darkBlack  bg-opacity-65">
      <div className="bg-darkSecondary rounded-lg shadow-lg w-[40%] max-[1000px]:w-[90%]  z-[100] p-6 max-[1000px]:p-2 relative">
        ...
        <div className="overflow-y-scroll z-[100]">{children}</div>
      </div>
    </div>
  );
};
